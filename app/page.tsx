...
const ports = [
  { name: "Warp", kind: "Terminal", description: "A complete terminal palette with restrained ANSI color and an orange cursor.", path: "agent_orange.yml", format: "YAML theme", href: "/api/themes/warp", sourceHref: `${githubUrl}/blob/main/themes/warp/agent_orange.yml`, logo: "https://cdn.simpleicons.org/warp/e8e8e8" },
  { name: "Neovim", kind: "Editor", description: "A practical colorscheme for focused editing, diagnostics, diffs, and code.", path: "agent_orange.lua", format: "Lua colorscheme", href: "/api/themes/nvim", sourceHref: `${githubUrl}/blob/main/themes/nvim/agent_orange.lua`, logo: "https://cdn.simpleicons.org/neovim/e8e8e8" },
  ...
  { name: "Expo", kind: "Native", description: "A React Native StyleSheet with intentional dark surfaces and semantic status colors.", path: "agent-orange.js", format: "React Native StyleSheet", href: "/api/themes/expo", sourceHref: `${githubUrl}/blob/main/themes/expo/agent-orange.js`, logo: "https://cdn.simpleicons.org/expo/e8e8e8" },
];
    ...
    <main className="min-h-screen overflow-hidden bg-background text-foreground selection:bg-[var(--agent-orange-focus)] selection:text-primary-foreground">
        ...
        <div className="relative mx-auto w-full max-w-xl lg:max-w-none">
          ...
          <div className="overflow-hidden rounded-lg border border-border bg-card shadow-xl shadow-black/10 dark:shadow-black/30">
            ...
            <div className="space-y-5 p-5 font-mono text-[12px] leading-6 sm:p-7 sm:text-[13px]">
              ...
              <p><span className="text-[var(--agent-orange-focus-text)]">const</span> <span>theme</span> <span className="text-muted-foreground">=</span> <span className="text-[var(--agent-orange-member)]">createTheme</span><span className="text-muted-foreground">(</span><span className="text-[var(--agent-orange-warning)]">&#123;</span></p>
              ...
              <p><span className="text-[var(--agent-orange-warning)]">&#125;</span><span className="text-muted-foreground">)</span></p>
      ...
      <section id="ports" className="scroll-mt-6 border-t border-border bg-secondary">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end"><div><p className="font-mono text-[11px] font-medium uppercase tracking-[0.18em] text-[var(--agent-orange-focus-text)]">Available now</p><h2 className="mt-3 font-heading text-3xl font-semibold tracking-[-0.04em] text-foreground sm:text-4xl">Choose your surface.</h2></div><p className="max-w-sm text-sm leading-6 text-muted-foreground">Shadcn leads the light-mode rollout. Each new port will receive its own contrast and semantic review.</p></div>
