...
const ports = [
  ...
  { name: "Skill.md", kind: "Workflow", description: "A reusable guide for building Agent Orange UI, new ports, and aligned theme surfaces.", path: "SKILL.md", format: "Agent Orange skill", href: "/api/themes/skill", sourceHref: `${githubUrl}/blob/main/.agents/skills/agent-orange/SKILL.md`, logo: "", icon: Bot, modes: false, downloadLabel: "Download" },
];
