...
export const siteConfig = {
  ...
  title: "Agent Orange — Developer Themes for Alacritty, Neovim & More",
  description:
    "A near-black developer theme for Alacritty, Neovim, Warp, Shadcn/UI, Expo, and ChatGPT Desktop, with orange focus and quiet semantic color.",
...
export const openGraphImage = {
  ...
  width: 1200,
  height: 630,
  alt: "Agent Orange developer themes for Alacritty, Neovim, Warp, Shadcn, Expo, and ChatGPT",
};
