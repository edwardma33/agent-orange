...
Run `npm run themes:check` after changing a shared value. It verifies that the Alacritty, Warp, Neovim, ShadCN, Expo, and GitHub-installable ShadCN registry forms still contain their required shared values.
